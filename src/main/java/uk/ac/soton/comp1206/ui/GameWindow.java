...
public class GameWindow {
    ...
    private void setupResources() {
        ...
        Font.loadFont(getClass().getResourceAsStream("/style/PlayfulTime-BLBB8.ttf"),32);
    }
    ...
    public void startGameOver() {
        loadScene(new GameOverScene(this));
    }
...
//    public void leaderBoard() { loadScene(new LeaderBoard(this)); }

    public void howChallenge() { loadScene(new InstructionsScene(this)); }
    ...
    /**
     * Display the game over scene with the final game state
